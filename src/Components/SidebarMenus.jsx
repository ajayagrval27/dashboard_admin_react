...
import '../Assets/Css/SidebarMenus.css'
import { Link, NavLink } from 'react-router-dom'
import { MdAccountCircle, MdHome, MdLocalActivity } from 'react-icons/md'
					...
					<div className="menu-container">
						<div className="menu-items">
							<div className="nav-items">
								...
								<NavLink to="/project">
									<div className="nav-icons">
										<AiFillProject className="nav-icons" />
									</div>
									<div className="nav-name">Projects</div>
								</NavLink>
								<NavLink to="/albums">
									<div className="nav-icons">
										<IoAlbums className="nav-icons" />
									</div>
									<div className="nav-name">Albums</div>
								</NavLink>
								<NavLink to="/recentActivites">
									<div className="nav-icons">
										<MdLocalActivity className="nav-icons" />
									</div>
